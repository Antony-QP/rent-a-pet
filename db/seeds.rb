...
pet1 = Pet.new(name: "Dillan", location: "Amsterdam", breed: "Staffordshire Terrier", description: "First dog", price: 150, user_id: user1.id)
...
pet2 = Pet.new(name: "Bob", location: "Berlin", breed: "Rhodesian Ridgeback", description: "Happy dog", price: 150, user_id: user2.id)
...
pet3 = Pet.new(name: "Sally", location: "London", breed: "Terrier", description: "Sad dog", price: 150, user_id: user3.id)
...
pet4 = Pet.new(name: "Vince", location: "Paris", breed: "Griffon Korthals", description: "Annoying dog", price: 150, user_id: user4.id)
