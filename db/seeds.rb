...
pet2 = Pet.new(name: "Bob", location: "De Bijvank", breed: "Rhodesian Ridgeback", description: "Bob is a 2 year old Rhodesian Ridgeback who will follow you everywhere! Beware, Bob doesn’t like solitude, so you can be sure you will have a strong presence.", price: 15, user_id: user1.id)
...
booking2.save!
booking3 = Booking.new(start_date: Date.new(2021,03,03), end_date: Date.new(2021,03,06), user_id: user2.id, pet_id: pet1.id)
booking3.save!
booking4 = Booking.new(start_date: Date.new(2021,03,03), end_date: Date.new(2021,03,06), user_id: user2.id, pet_id: pet2.id)   
booking4.save!
