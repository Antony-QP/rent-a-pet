...
pet1 = Pet.new(name: "Dillan", location: "Brabantse Bellefleur", breed: "Staffordshire Terrier", description: "First dog", price: 15, user_id: user1.id)
...
pet3 = Pet.new(name: "Sally", location: "Rendierweg", breed: "Terrier", description: "Sad dog", price: 15, user_id: user3.id)
...
pet4 = Pet.new(name: "Vince", location: "Herenstraat", breed: "Griffon Korthals", description: "Annoying dog", price: 15, user_id: user4.id)
...
pet5 = Pet.new(name: "Bob", location: "Tweeloo", breed: "English Bull Terrier", description: "A lovely companion", price: 15, user_id: user5.id)
...
pet6 = Pet.new(name: "Johnny", location: "Spaarnelaan", breed: "Labrador", description: "A great sporting dog", price: 15, user_id: user6.id)
...
pet7 = Pet.new(name: "Vince", location: "Ansfriduslaan", breed: "German Shepherd", description: "Will keep you safe", price: 15, user_id: user7.id)
...
pet8 = Pet.new(name: "Augustus", location: "Pastoor Attendorenstraat ", breed: "Parrot", description: "Not for the faint hearted", price: 15, user_id: user8.id)
...
pet9 = Pet.new(name: "Fuzzy", location: "Renswoudsestraatweg", breed: "Rabbit", description: "Keep you entertained", price: 15, user_id: user9.id)
